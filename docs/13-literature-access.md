...
**Contents:** [Data](#data) (2) · [Software](#software) (8) · [Literature](#literature) (32) · [Publishing](#publishing) (5) · [Funding](#funding) (2) · [Learning](#learning) (6) · [Community](#community) (4)
...
Free desktop application by Anne-Wil Harzing that retrieves citations from multiple sources and computes citation metrics including h-index and variants, for individual academics, journals or research areas. Actively maintained — the guide page was last updated in July 2026.
...
**Caveats.** Verified free Basic tier on 2026-08-28: unlimited search across 138M+ papers, unlimited summaries, unlimited chat with papers including full text, source display, and Zotero import — but only 'limited usage' of the Research Agent and Research Reports, and no export. Export to RIS/CSV/BIB/PDF/DOCX starts at the Plus tier ($11/user/month billed annually on the academic price list; $39 for Pro). No export on the free tier is the real constraint: you can explore but not take your results with you. As with all LLM extraction, verify every extracted value against the paper before it enters your analysis.
...
**Caveats.** Search this when a DOI resolves to a dead link — it is the best chance of recovering a paper from a defunct journal. The interface now sits behind a JavaScript bot check, so scripted fetching fails; use a browser or the Fatcat API. Development has been quiet for some time and metadata quality is uneven compared with Crossref or OpenAlex, but the archive itself is live and searchable.
...
PubMed holds 40,909,560 citation records; PubMed Central holds 12,305,236 full-text articles, of which 8,183,131 carry the open-access filter (checked 2026-08-28). MeSH indexing makes PubMed the most precisely searchable biomedical corpus in existence.
...
Non-profit membership network of scholar-controlled journals operating on the Fair Open Access model: no charges to readers and no charges to authors. Member journals are listed by discipline and include well-regarded mathematics, physics, linguistics and computer science titles.
